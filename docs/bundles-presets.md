...
| `bundles.better-sidebar` | `dsh-better-sidebar`              | 0.12.2                | VSCode-like right sidebar for the DSH web UI · [homepage](https://github.com/omdsh-dev/DSH-better-sidebar)                                             |
...
| `bundles.modlens`        | `dsh-modlens`                     | 3.17.0                | Plug-in vision for text-only LLMs · [homepage](https://github.com/liustack/modlens)                                                                    |
...
| `bundles.tianshu-tui`    | `dsh-tianshu-tui`                 | 0.1.2-rc.9            | Interactive TUI layer for dsh with rendering, panels, and terminal controls · [homepage](https://github.com/huiliyi37/dsh-tianshu-tui)                 |
