...
| `bundles.tianshu-tui`    | `dsh-tianshu-tui`                 | 0.1.2-rc.8            | Interactive TUI layer for dsh with rendering, panels, and terminal controls · [homepage](https://github.com/huiliyi37/dsh-tianshu-tui)                 |
