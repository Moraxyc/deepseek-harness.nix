...
<nav class="home-index" aria-label="Documentation index">
  <a class="home-index-item" href="catalog/">
    ...
    <span class="home-index-copy">
      <strong>Bundles &amp; presets</strong>
      <small>Catalog of available outputs and profiles</small>
    </span>
    <span class="home-index-arrow" aria-hidden="true">
      →
    </span>
  </a>
  <a class="home-index-item" href="getting-started/">
    ...
    <span class="home-index-copy">
      ...
      <small>Remote flake commands, outputs, and Cachix</small>
    </span>
    <span class="home-index-arrow" aria-hidden="true">
      →
    </span>
  ...
  <a class="home-index-item" href="nixos/">
    ...
    <span class="home-index-copy">
      <strong>NixOS integration</strong>
      <small>Modules for profiles and the web service</small>
    </span>
    <span class="home-index-arrow" aria-hidden="true">
      →
    </span>
  ...
  <a class="home-index-item" href="development/">
    ...
    <span class="home-index-copy">
      ...
      <small>Build, extend, and maintain the flake</small>
    </span>
    <span class="home-index-arrow" aria-hidden="true">
      →
    </span>
