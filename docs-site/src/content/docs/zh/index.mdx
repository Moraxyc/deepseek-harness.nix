...
<nav class="home-index" aria-label="文档目录">
  <a class="home-index-item" href="catalog/">
    ...
    <span class="home-index-copy">
      <strong>Bundles 和预设</strong>
      <small>查看可用输出和 profile</small>
    </span>
  ...
  <a class="home-index-item" href="getting-started/">
    ...
    <span class="home-index-copy">
      <strong>快速开始</strong>
      <small>远程 flake 命令、输出和 Cachix</small>
    </span>
    <span class="home-index-arrow" aria-hidden="true">
      →
    </span>
  ...
  <a class="home-index-item" href="nixos/">
    ...
    <span class="home-index-copy">
      <strong>NixOS 集成</strong>
      <small>通过模块启用 profile 和 web 服务</small>
    </span>
    <span class="home-index-arrow" aria-hidden="true">
      →
    </span>
